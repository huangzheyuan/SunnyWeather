...
private val sky= mapOf(
    "CLEAR_DAY" to Sky("晴", R.drawable.ic_clear_day,R.drawable.ic_clear_day),
    "CLEAR_NIGHT" to Sky("晴",R.drawable.ic_clear_night,R.drawable.ic_clear_night),
    "PARTLY_CLOUDY_DAY" to Sky("多云",R.drawable.ic_partly_cloud_day,R.drawable.ic_partly_cloud_day),
    "PARTLY_CLOUDY_NIGHT" to Sky("多云",R.drawable.ic_partly_cloud_night,R.drawable.ic_partly_cloud_night),
    "CLOUDY" to Sky("阴",R.drawable.ic_cloudy,R.drawable.ic_cloudy),
    ...
    "BUST" to Sky("浮尘",R.drawable.ic_fog,R.drawable.bg_fog)
)
